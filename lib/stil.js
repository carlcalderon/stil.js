...
module.exports = (function () {
  ...
  for (key in foreground) {
    String.prototype.__defineGetter__(key, (function (input) {
      return function () {
        this.color = input;
        return style(this, input, this.bgcolor || null, this.decor || null);
      };
    }(key)));
  }
  ...
  for (key in background) {
    String.prototype.__defineGetter__('on' + firstUp(key), (function (input) {
      return function () {
        this.bgcolor  = input;
        return style(this, this.color || null, input, this.decor || null);
      };
    }(key)));
  }
  ...
  for (key in decoration) {
    String.prototype.__defineGetter__('as' + firstUp(key), (function (input) {
      return function () {
        this.decor = input;
        return style(this, this.color || null, this.bgcolor  || null, input);
      };
    }(key)));
  }
